...
public class IntJoukkoTest {
    ...
    public void lukujaLisattyMaara() {
        ...
        assertEquals(3, joukko.joukonAlkioidenLkm());
    }
    ...
    public void samaLukuMeneeJoukkoonVaanKerran() {
        joukko.lisaaLukuJoukkoon(10);
        joukko.lisaaLukuJoukkoon(3);
        assertEquals(2, joukko.joukonAlkioidenLkm());
    }

    @Test
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.sisaltyyJoukkoon(10));
        assertFalse(joukko.sisaltyyJoukkoon(5));
        assertTrue(joukko.sisaltyyJoukkoon(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poistaLukuJoukosta(3);
        assertFalse(joukko.sisaltyyJoukkoon(3));
        assertEquals(1, joukko.joukonAlkioidenLkm());
    }
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertEquals(14, joukko.joukonAlkioidenLkm());
        assertTrue(joukko.sisaltyyJoukkoon(11));
        joukko.poistaLukuJoukosta(11);
        assertFalse(joukko.sisaltyyJoukkoon(11));
        assertEquals(13, joukko.joukonAlkioidenLkm());
    }
